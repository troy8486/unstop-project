...
const AssignedAssesmentCard = ({ assessment }) => {
  const opacity = 1;
  const durationDisplay = assessment.duration.slice(0, 2);
  return (
    <div className="flex flex-col bg-white border-2 w-[98%] md:w-[32%] h-44 rounded-2xl cursor-pointer pt-4 mx-2 my-2">
      ...
      <div className="flex justify-between px-4">
        ...
        <div className="flex">
          ...
          <div>
            <h1 className="text-2xl text-sky-900 font-semibold mx-2">
              {assessment.name}
            </h1>
            ...
            <div className="flex justify-center items-center">
              ...
              <div className="flex justify-center items-center border-l border-gray-300 px-2 h-5">
                <CalendarMonthIcon style={{fontSize:25, marginRight: 5, color: `rgba(55, 65, 81, ${opacity})`}}/>
...
export default AssignedAssesmentCard;
